...
//this is the schema for creating a new event. it validates everything
...
const getEvents = async (req, res) => {
    ...
    //timezone conversion if requested
    if (tz) {
...
const getEventById = async (req, res) => {
    ...
    //converts to the requested timezone 
    if (tz) {
...
const updateEvent = async (req, res) => {
    ...
    //only add log if something is actually changed
